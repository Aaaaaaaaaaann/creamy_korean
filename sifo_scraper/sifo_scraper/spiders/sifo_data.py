urls = [
    ...
    # # moistening
    # 'https://sifo.ru/lico/mfp/17-proizvodstvo,yuzhnaya-koreya/stock_status,7',
    # # hair
...
stopWords = ['set', 'бритва', 'кассеты', 'клей', 'коконы', 'краска', 'лопатка', 'массажер', 'мочалка', 'набор,', 'пилка',
             'чаша', 'щетка']
